...
def npm_package_version(options, pkg, dev=False):
    with open(os.path.join(options.grammar_dir,"package.json"), "r") as file:
        package_json = json.load(file)
        dependencies = package_json.get("devDependencies" if dev else "dependencies", {})
